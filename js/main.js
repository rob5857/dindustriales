...
const TRANSLATIONS = {
  es: {
    ...
    faq_a6: '<p>Inspeccionamos los daños, preparamos el <strong>estimado detallado</strong>, coordinamos con el ajustador y negociamos con MAPFRE, Triple-S, Cooperativa de Seguros, One Alliance, Multinational y USIC.</p>',
    ...
    bp_intro: 'Cuando tu hogar sufre daños, no solo enfrentas una reparación…<br><strong>enfrentas papeleo, burocracia y la presión de las aseguradoras.</strong>',
    bp_body1: 'En <strong>Desarrollos Industriales LLC</strong> estamos para ayudarte, orientarte y representarte. <span class="bp-highlight">Luchamos para que recibas lo que realmente mereces.</span>',
  ...
  en: {
    ...
    faq_a3: '<p>Most policies in Puerto Rico cover structural fire damage, <strong>smoke and soot restoration</strong>, water damage from firefighting systems, and content policies (furniture, electronics, documents). We help you claim the maximum with MAPFRE, Triple-S, Cooperativa de Seguros, and more.</p>',
    ...
    bp_intro: 'When your home suffers damage, you don\'t just face a repair…<br><strong>you face paperwork, bureaucracy, and pressure from the insurance companies.</strong>',
    bp_body1: 'At <strong>Desarrollos Industriales LLC</strong> we are here to help, guide, and represent you. <span class="bp-highlight">We fight so you receive what you truly deserve.</span>',
